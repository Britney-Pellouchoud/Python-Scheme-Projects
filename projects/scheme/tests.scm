...
(define x (* (+ 3 2) (/ 10 2) (- 8 5)))
x
; expect 75

(define (gunc l) (define (y x) (define l k)))
(gunc 12)
;expect y
((gunc 12) 3)
; expect Error
...
(lambda (q r z) (* q r z))
;expect (lambda (q r z) (* q r z))

(map (lambda (z) (car (cdr z))) '((1 2 3) (4 5 6)))
; expect (2 5)

(filter odd? '(1 2 3 4 5))
; expect (1 3 5)

(define (k x y) (define z r q))
(k 2)
; expect Error 
...
(cond 
  ((equal? #f 12) 'incorrect)
  (else 'correct)
  )
; expect correct

(define question (cons '(does this pass a test case) (cons '? nil)))
; expect question
question
; expect ((does this pass a test case) ?)

(define error-list `((/ 1 0) ,2))
; expect error-list
error-list
;expect ((/ 1 0) 2)
; END PROBLEM 0
